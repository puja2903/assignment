	...
	public class Assignment {
		...
		public static void main(String[] args) {
	        ...
	        try {
	        	...
	        	System.out.println("Give the 1st input:");  //asking for the input
	            
	            int x = in .nextInt();   //Storing the value
	            int y = in .nextInt();
	            ...
	            System.out.println("ArithmeticException");   //print the exception if occur
